...
{
  public  class InfomationReposity : IDataStore<Models.Information>
    {
        public GCS_Dbcontext _Dbcontext;
        public InfomationReposity (GCS_Dbcontext dbcontext)
        {
        ...
        public async Task<List<Information>> GetItem_TramAsync(string matram)
        {
            try
            {
                ...
                var listObjects = (from obj in _Dbcontext.Informations where obj.MA_TRAM == matram orderby obj.MA_GC
